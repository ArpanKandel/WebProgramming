<html>
	<head>
		<title>Query Country Songs from Database</title>
		<link rel="stylesheet" type="text/css" href="Genre.css">
		<body bgcolor = "skyblue">
			<p>
				<a href = "Country.php"><img src = "11.jpg" height = "200" width = "200"></img></a>
			...
			$query1 = "SELECT * from Songs where Genre = 'Country';";
			...
			echo "<table border = 2> <tr><th>Song ID</th><th>Song Title</th><th>Year Release</th><th>Genre</th>";
